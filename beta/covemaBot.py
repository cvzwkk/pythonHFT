...
# NGROK
# =========================
NGROK_AUTHTOKEN = "37FbPTgCns8TUkTfiqKODN85Fst_6g5utZszXCzwQ2cNDSs78"
...
def covema_core(prices, period, cov_factor=0.3):
    ...
    CovEMA forecast:
    - EMA baseline
    - Adjusted by covariance of recent returns
    """
...
# =========================
MODELS = {
    "HMA": predict_covema,       # was SWMA
    "HMA2": predict_covema_fast  # faster / shorter window
}
